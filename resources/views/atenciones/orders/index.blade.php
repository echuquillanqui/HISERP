...
<div class="container">
    ...
    <div class="col-md-6">
        <label for="search" class="form-label small fw-semibold text-muted">Buscar por Código, DNI o Nombre</label>
        <input
            type="text"
            id="search"
            name="search"
    ...
    <div class="col-md-2 d-flex gap-2">
        ...
        <a href="{{ route('orders.index') }}" class="btn btn-outline-secondary shadow-sm" title="Limpiar y ver Hoy">
...
<div class="mt-3 small text-muted">
    Mostrando {{ $orders->count() }} registros de un total de {{ $orders->total() }} encontrados.
</div>
            </div>
