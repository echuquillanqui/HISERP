...
Route::get('products-kardex/registros', [App\Http\Controllers\ProductController::class, 'movementRecords'])->name('products.kardex.records');
Route::get('products-kardex/movimientos', [App\Http\Controllers\ProductController::class, 'kardexMovements'])->name('products.kardex.movements');
Route::get('products-kardex/vendidos', [App\Http\Controllers\ProductController::class, 'soldMedicines'])->name('products.kardex.sold');
...
Route::get('products-kardex/registros/pdf', [App\Http\Controllers\ProductController::class, 'exportMovementRecordsPdf'])->name('products.kardex.records.pdf');
Route::get('products-kardex/registros/excel', [App\Http\Controllers\ProductController::class, 'exportMovementRecordsExcel'])->name('products.kardex.records.excel');
Route::get('products-kardex/movimientos/pdf', [App\Http\Controllers\ProductController::class, 'exportKardexMovementsPdf'])->name('products.kardex.movements.pdf');
Route::get('products-kardex/movimientos/excel', [App\Http\Controllers\ProductController::class, 'exportKardexMovementsExcel'])->name('products.kardex.movements.excel');
Route::get('products-kardex/vendidos/pdf', [App\Http\Controllers\ProductController::class, 'exportSoldMedicinesPdf'])->name('products.kardex.sold.pdf');
Route::get('products-kardex/vendidos/excel', [App\Http\Controllers\ProductController::class, 'exportSoldMedicinesExcel'])->name('products.kardex.sold.excel');
...
Route::post('/control-insumos/marcas', [App\Http\Controllers\ControlInsumoController::class, 'storeBrand'])->middleware('auth')->name('control-insumos.brands.store');
