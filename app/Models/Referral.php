...
class Referral extends Model
{
    ...
    /**
     * Relación con la numeración anual utilizada para generar el código.
     */
    public function numeration(): BelongsTo
    {
        return $this->belongsTo(ReferralNumerations::class, 'numeration_id');
    }
